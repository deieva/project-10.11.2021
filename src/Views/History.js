    ...
    return (
        <div>
            <div class="content">
                ...
                <button class="accordion">GenCode</button>
                <div class="panel">
                ...
                <button class="accordion">troff and nroff</button>
                <div class="panel">
                ...
                <button class="accordion">TeX</button>
                <div class="panel">
                ...
                <button class="accordion">Scribe, GML and SGML</button>
                <div class="panel">
                ...
                <button class="accordion">XML</button>
                <div class="panel">
                ...
                <button class="accordion">XHTML</button>
                <div class="panel">
