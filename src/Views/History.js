    ...
    return (
        <div>
            <div className="content">
                ...
                <button className="accordion">GenCode</button>
                <div className="panel">
                ...
                <button className="accordion">troff and nroff</button>
                <div className="panel">
                ...
                <button className="accordion">TeX</button>
                <div className="panel">
                ...
                <button className="accordion">Scribe, GML and SGML</button>
                <div className="panel">
                ...
                <button className="accordion">HTML</button>
                <div className="panel">
                ...
                <button className="accordion">XML</button>
                <div className="panel">
                ...
                <button className="accordion">XHTML</button>
                <div className="panel">
